...
// Active Stocks Data - Generate 30 stocks for grid
...
// Heatmap Stocks Data - Large grid
      ...
      <VCardText class="d-flex align-center justify-space-between flex-wrap gap-4 py-3">
        <div>
          ...
          <div class="d-flex gap-2">
            <VChip 
              :color="activeTab === 'heatmap' ? 'primary' : 'default'" 
              :variant="activeTab === 'heatmap' ? 'flat' : 'outlined'" 
              size="small"
              @click="activeTab = 'heatmap'"
            >Heatmap</VChip>
            <VChip 
              :color="activeTab === 'market' ? 'primary' : 'default'" 
              :variant="activeTab === 'market' ? 'flat' : 'outlined'" 
              size="small"
              @click="activeTab = 'market'"
            >Market View</VChip>
            <VChip 
              :color="activeTab === 'nifty' ? 'primary' : 'default'" 
              :variant="activeTab === 'nifty' ? 'flat' : 'outlined'" 
              size="small"
              @click="activeTab = 'nifty'"
            >Nifty Tour</VChip>
          </div>
        </div>
      ...
      <VCardText class="py-2">
        ...
        <div class="d-flex align-center gap-2 mb-3 flex-wrap">
          <VChip
            ...
            :key="tab.value"
            :color="activeStockTab === tab.value ? 'success' : 'default'"
            :variant="activeStockTab === tab.value ? 'flat' : 'outlined'"
            size="small"
            @click="activeStockTab = tab.value"
          >{{ tab.label }}</VChip>
          <VSpacer />
          <div class="d-flex align-center gap-2">
        ...
        <div class="text-caption text-medium-emphasis mt-2">
          Note :- Last Refresh Date Time: {{ lastRefreshTime }}
        </div>
      </VCardText>
    </VCard>
